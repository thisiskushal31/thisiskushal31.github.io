      ...
      <div className="container mx-auto text-center">
        <div className="animate-fade-in">
          ...
          <h3 className="text-xl md:text-2xl text-slate-300 mb-6">
            Platform Engineering · DevOps · Cloud Infrastructure · Cloud-Native Software Development
          </h3>
          <p className="text-lg md:text-xl text-slate-400 max-w-3xl mx-auto mb-8 leading-relaxed">
            I build cloud-native platforms and automate infrastructure to improve developer experience, security, and scalability—enabling teams to move faster and build reliably.
          </p>
